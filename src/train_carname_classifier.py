...
def train_model(model, criterion, optimizer, scheduler, num_epochs=25):
    ...
    with open('models/car_name_classifier_history.json', 'w') as f:
        json.dump(history, f, indent=4)
    print('Training history saved to models/car_name_classifier_history.json')
...
if __name__ == '__main__':
    ...
    with open('models/carname_classes.json', 'w') as f:
